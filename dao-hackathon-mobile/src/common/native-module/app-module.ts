...
export const MMKVStorage = {
  ...
  getNumber: async (key: string, option?: MMKVOption): Promise<number> => {
  ...
  getBoolean: async (key: string, option?: MMKVOption): Promise<boolean> => {
  ...
  getAllKeys: async (option?: MMKVOption): Promise<Array<string>> => {
    return AppModule.mmkvGetAllKeys(
      option?.id ?? undefined,
      option?.cryptKey ?? undefined,
    );
  },
  clearAll: async (option?: MMKVOption): Promise<Array<string>> => {
    return AppModule.mmkvClearAll(
      option?.id ?? undefined,
      option?.cryptKey ?? undefined,
    );
  },
  delete: async (key: string, option?: MMKVOption): Promise<boolean> => {
...
export const setEnableIQKeyboard = () => {
  if (!isIos) {
    return;
  }
