...
// File @openzeppelin/contracts/governance/utils/Votes.sol@v4.8.2
...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721Votes.sol@v4.8.2
...
// File contracts/card/CardVotes.sol
...
contract Card is CardVotes, ERC721URIStorage, Ownable {
    ...
    function mintWithPosition(
        ...
        uint256 tokenId = this.mint(to, _tokenUri);
        _cardPosition.setPosition(tokenId, position);
        return tokenId;
    }
    ...
    function _burn(
        uint256 tokenId
    ) internal override(CardVotes, ERC721URIStorage) {
        super._burn(tokenId);
    }
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view override(ERC721, CardVotes) returns (bool) {
        return super.supportsInterface(interfaceId);
    }
}
